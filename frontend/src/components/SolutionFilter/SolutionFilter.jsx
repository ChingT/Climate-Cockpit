...
import {
  ...
  SortingOption, TitleAndImage, // Added for sorting options
    ...
    <DropdownLayout>
      ...
      {isDropdownOpen && (
        <DropdownContent>
          ...
          <DropdownSort>
            <TitleAndImage>
            <img src={sorting_icon} alt="Sort Icon" style={{"width": "20px"}}/>
              <h3>Sorting Options</h3>
              </TitleAndImage>
            <SortingOption value="Impact">Impact</SortingOption>
            <SortingOption value="Alphabetically">Alphabetically</SortingOption>
            <SortingOption value="Number of Supporters">Number of Supporters</SortingOption>
          </DropdownSort>
          <DropdownSort>
            <TitleAndImage>
          <img src={filter_icon} alt="Filter Icon" />
