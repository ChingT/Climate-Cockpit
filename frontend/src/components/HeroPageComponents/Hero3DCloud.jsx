...
import {
  CloudBase, CloudLayer,
  Container,
  Viewport,
  World
} from "./Hero3DCloud.style.js";
...
const Hero3DCloud = () => {
    ...
    useEffect(() => {
        ...
        if (!viewport) {
            console.error("Viewport not found in the DOM. Make sure your HTML structure is correct.");
            return;
        }
        ...
        function updateView() {
            ...
            world.style.webkitTransform = world.style.MozTransform = world.style.msTransform = world.style.oTransform = world.style.transform = t;
        }
        ...
        function update() {
            for (let j = 0; j < layers.length; j++) {
                ...
                layer.style.webkitTransform = layer.style.MozTransform = layer.style.msTransform = layer.style.oTransform = layer.style.transform = t;
            }
